  ...
  return (
    <Center bg='main.100' py={10}>
      <Flex flexDirection='column'>
        ...
        <Flex mt={5}>
          <a href='https://github.com/pankod' target='_blank' style={iconStyle} rel='noreferrer'>
            <Image data-test='icon' src='/icons/github-icon.svg' alt='github' width='28' height='29' />
          </a>
          <a href='https://twitter.com/PankodDev' target='_blank' style={iconStyle} rel='noreferrer'>
